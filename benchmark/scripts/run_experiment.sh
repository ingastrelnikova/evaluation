...
REMOTE_SCRIPT_PATH="/home/$VM_USER/app/benchmark/scripts/setup_experiment.sh"
...
gcloud compute ssh $VM_USER@$VM_NAME --zone=$ZONE --command="chmod +x $REMOTE_SCRIPT_PATH && sudo $REMOTE_SCRIPT_PATH"
